...
export function getThawAccountInstructionDataSerializer(): Serializer<
...
> {
  return mapSerializer<
    ...
    ThawAccountInstructionData
  >(
    struct<ThawAccountInstructionData>([['discriminator', u8()]], {
      description: 'ThawAccountInstructionData',
    }),
...
export function thawAccount(
  ...
  // Data.
  const data = getThawAccountInstructionDataSerializer().serialize({});
